...
public class C02 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		birlesik(name1, name2);
				

	}

	private static void birlesik(String name1, String name2) {
		
		
		if (name1.length()%2==0) {
			
			System.out.println(name1=name1.substring(0, name1.length()/2)+name2+name1.substring(name1.length()/2));
